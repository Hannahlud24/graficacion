...
// cuerpo vestido rojo
  ...
  fill(0);
  ellipse(x - 8*s, y - 10*s, 4*s, 4*s);
  ellipse(x + 8*s, y - 12*s, 4*s, 4*s);

  // mejilla
  fill(255,105,130);
  ellipse(x + -15*s, y + 8*s, 10*s, 10*s);
  ...
  line(x - 20*s, y + 40*s, x - 35*s, y + 30*s);
  line(x + 20*s, y + 40*s, x + 35*s, y + 30*s);
  line(536,296,541,298);
  line(537,294,541,290);
  line(535,294,536,288);

  line(465,295,458,298);
  line(466,295,457,290);
  line(464,294,465,288);
